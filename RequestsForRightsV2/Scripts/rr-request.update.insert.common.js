...
$(function () {
    ...
    function updateUserFields(user, suggestion) {
        user.find(".rr-request-user-login input").val(suggestion.data.Login).attr("title", suggestion.data.Login);
        user.find(".rr-request-user-post input").val(suggestion.data.Post).attr("title", suggestion.data.Post);
        user.find(".rr-request-user-department input").val(suggestion.data.Department).attr("title", suggestion.data.Department);
        user.find(".rr-request-user-unit input").val(suggestion.data.Unit).attr("title", suggestion.data.Unit);
        user.find(".rr-request-user-office input").val(suggestion.data.Office).attr("title", suggestion.data.Office);
        user.find(".rr-request-user-phone input").val(suggestion.data.Phone).attr("title", suggestion.data.Phone);
    }
