...
{
    public class ReportDepartmentAndResourceRightsOptionsValueProvider : 
        ReportOptionsValueProvider<ReportDepartmentAndResourceRightsOptions>, IValueProvider
    {
        public new bool ContainsPrefix(string prefix)
        {
            try
            {
                ...
                return parameter != null && parameter.ParameterType == typeof(ReportDepartmentAndResourceRightsOptions);
            }
