...
namespace RequestsForRights.Web.Infrastructure.Services.Interfaces
{
    public interface IRightService
    {
        ...
        IEnumerable<ResourceUserRightModel> GetDepartmentRightsOnDate(DateTime date, string department, string unit);
        IEnumerable<ResourceUserRightModel> GetDepartmentAndResourceRightsOnDate(DateTime date, string department, string unit, int? idResource);
